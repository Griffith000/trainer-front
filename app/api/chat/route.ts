...
function buildSystemPrompt(profile: UserProfile): string {
  ...
  const lines = [
    ...
    "When you generate a workout plan, ALWAYS call saveWorkoutPlan immediately after presenting it — do not ask the user first.",
    "When you generate a diet or nutrition plan, ALWAYS call saveDietPlan immediately after presenting it — do not ask the user first.",
